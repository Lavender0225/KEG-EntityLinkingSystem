...
//	private double sim_label_context;
	...
	private double contextWordsSim;
...
//		sim_desc = 0;
	...
	public void setContextWordsSim(double contextWordsSim) {
		this.contextWordsSim = contextWordsSim;
	}


	public double getContextEntitySim() {
		return contextEntitySim;
	}


	public void setContextEntitySim(double contextEntitySim) {
		this.contextEntitySim = contextEntitySim;
	}


	public double getBelifScore() {
		return belifScore;
	}


	public void setBelifScore(double belifScore) {
		this.belifScore = belifScore;
	}
