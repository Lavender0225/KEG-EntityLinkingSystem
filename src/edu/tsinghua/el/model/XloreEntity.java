...
public class XloreEntity extends AbstractEntity{
	private String uri;
	...
	public XloreEntity(String id, String label_zh, String label_en, ArrayList<String> alias, 
	...
	public XloreEntity(String label, String id) {
		super(id);
		title = label;
	}
